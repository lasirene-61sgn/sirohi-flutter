...
class _LoginScreenState extends ConsumerState<LoginScreen> {
  ...
  Future<void> _loadDeviceToken() async {
    ...
    if (dToken == null || dToken!.isEmpty) {
      dToken = await NotificationService.getToken();

      if (dToken != null) {
        await SharedPreferencesHelper().setString("DToken", dToken!);
      }
    }

    debugPrint("$dToken is the sharedToken");
  }
  @override
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                const Text('Shree Sirohi Jain Sangh Chennai', textAlign: TextAlign.center, style: TextStyle(fontSize: 28, fontWeight: FontWeight.bold, color: AppTheme.primaryBlue)),
