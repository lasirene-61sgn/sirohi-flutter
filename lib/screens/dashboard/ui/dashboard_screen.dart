...
import 'package:flutter_app/screens/help_line/ui/helpline_screen.dart';
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            ...
            const Expanded(child: Text("Today's Birthdays")),
          ],
        ),
        content: SizedBox(
      ...
      builder: (context) => AlertDialog(
        title: Row(
          children: [
            ...
            const SizedBox(width: 12),
            const Expanded(child: Text("Today's Anniversaries")),
          ],
        ),
        content: SizedBox(
          width: double.maxFinite,
              ...
              return InkWell(
                ...
                child: GestureDetector(
                  onTap: () async {
                    ...
                    } else if(notification.type == "anniversary"  ||notification.type == "anniversary_added") {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => const AnniversaryScreen(),
                      ...
                      leading: Container(
                        ...
                        decoration: BoxDecoration(
                          color: notification.type == "event" ||notification.type == "event_added"
                              ? Color(0xFF4CAF50)
                              : notification.type == "gallery_added"  ||notification.type == "gallery"
                              ? Color(0xFF2196F3)
...
//
//   final List<String> _newsItems = [
//     '📢 Welcome to Shree Sirohi Jain Sangh Chennai',
//     '🎉 Annual General Meeting on 15th December 2024',
//     '🌟 New member registrations are now open',
//     '📅 Upcoming Diwali celebration on 20th December',
//     '💼 Business networking event next month',
...
//     super.initState();
//     _controller = AnimationController(
//       duration: const Duration(seconds: 30), // Duration for one complete scroll
//       vsync: this,
//     )..repeat(); // Repeat indefinitely
//
//     _animation = Tween<Offset>(
//       begin: const Offset(1.0, 0.0), // Start from right
//       end: const Offset(-1.0, 0.0),   // Move to left
...
//                 children: [
//                   _buildNewsText(newsText),
//                   _buildNewsText(newsText), // Duplicate for seamless loop
//                 ],
//               ),
//             ),
//             // Left fade gradient
...
//                     colors: [
//                       const Color(0xFF1E90FF).withValues(alpha: 1.0),
//                       const Color(0xFF1E90FF).withValues(alpha: 0.0),
//                     ],
//                     begin: Alignment.centerLeft,
//                     end: Alignment.centerRight,
//                   ),
